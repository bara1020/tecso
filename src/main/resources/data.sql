...
INSERT INTO currency_account (currency, code, min_value, creation_timestamp, modification_timestamp, version_number) 
VALUES ('peso', '$', 1000, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1);

INSERT INTO currency_account (currency, code,min_value, creation_timestamp, modification_timestamp, version_number) 
VALUES ('dolar', '$', 300, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1);

INSERT INTO currency_account (currency, code,min_value, creation_timestamp, modification_timestamp, version_number) 
VALUES ('euro', '€', 100, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1);
